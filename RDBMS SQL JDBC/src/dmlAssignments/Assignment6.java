...
public class Assignment6 
{
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException 
	{
	    ...
	    ResultSet rs = s.executeQuery("select * from employee where EMPLOYEE_ID=202");
		...
		String updateQuery = "Update employee SET LAST_NAME = 'Higgins' Where EMPLOYEE_ID=202"; // Fay
