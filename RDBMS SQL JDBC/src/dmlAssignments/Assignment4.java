...
{
	/*
	 * Insert one record without listing the column names in the insert statement where salary
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException 
	{
		...
		/*
		 * This Assignment 5 is already done
		 * 
		...
		/*
		 * This Assignment 6 is already done
		 * 
		 ...
		 */
		// first row is inseted in Assignment3
		Connection con = new GetConnection().getConnection();
		Statement s = con.createStatement();
		
		String insert_query = "Insert into employee values(208, 'Navi', 'Singh', 'MHARTSTE', 5001005555, TO_DATE('2012-04-26', 'yyyy/mm/dd'), 'MK_MAN', (null), 0.0, 100, 20)";
